...
if (salarioBruto <= 1556.94) {
    ...
    salarioBaseInss = salarioBruto - descontoInss;
    console.log(salarioBaseInss);
}
    ...
    if (salarioBruto >=1903.99 && salarioBruto <= 2826.65) {
        descontoIr = (salarioBaseInss * 7.5) / 100 - 142.80;
        salarioLiquido = salarioBaseInss - descontoIr;
